...
class RecomendarHabitacion(KnowledgeEngine):
    ...
    def carga_habitación(self):
        ...
        yield Habitacion(servicio="Complementario",numero='1012', residencia="Nativo", cantidad="2", tipo="Single doble" )
        yield Habitacion(servicio="Complementario",numero='10111', residencia="Nativo", cantidad="4", tipo="Single cuádruple" )
        yield Habitacion(servicio="Complementario", numero='101112',residencia="Nativo", cantidad="5", tipo="Single quíntuple" )
        yield Habitacion(servicio="Complementario", numero='104211',residencia="Nativo", cantidad="1", tipo="Suite junior" )
        yield Habitacion(servicio="Vista panoramica", numero='101214',residencia="Extrangero", cantidad="2", tipo="Suite senior" )
